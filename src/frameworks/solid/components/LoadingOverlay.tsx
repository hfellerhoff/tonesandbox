...
export default function LoadingOverlay(props: ParentProps) {
  ...
  return (
    <Show
      ...
      fallback={
        <div class="fixed w-screen h-screen inset-0 z-50 bg-gray-200 dark:bg-gray-700 bg-opacity-50 dark:bg-opacity-50 flex flex-col items-center justify-center gap-4">
